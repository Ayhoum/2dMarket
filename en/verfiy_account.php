...
<head>
	...
	<title>2D Market | Welcome to 2D Market</title>
	<style type='text/css'>
		/* ----- Custom Font Import ----- */
				...
				<tr>
					<td align='center' valign='top'>
						...
						<table class='container hero-subheader' border='0' cellpadding='0' cellspacing='0' width='620' style='width: 620px;'>
							<tr>
								<td class='hero-subheader__title' style='direction:ltr;font-size: 43px; font-weight: bold; padding: 80px 0 15px 0;' align='center'>Welcome to 2D Market</td>
							</tr>
