            ...
            <div class="heading-panel">
                <div class="col-xs-12 col-md-12 col-sm-12">
                    <h3 class="main-title text-left">
                        Latest Ads in <a href="ad_per_cat.php?cat_id=59&dis=all&price=all&order=latest" style="color: rgba(166,85,218,0.86) ">Electronics</a>
                    </h3>
                </div>
            </div>
            <!-- Middle Content Box -->
            <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="featured-slider owl-carousel owl-theme">
                        ...
                        $query_1  = "SELECT * FROM `ADVERTISEMENT` WHERE `CATEGORY_id` = '59'";
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="heading-panel">
                <div class="col-xs-12 col-md-12 col-sm-12">
                    <h3 class="main-title text-left">
                        Latest Ads in <a href="ad_per_cat.php?cat_id=75&dis=all&price=all&order=latest" style="color:  rgba(166,85,218,0.86) ">Cars & Motorbikes</a>
                    </h3>
                </div>
            </div>
            <!-- Middle Content Box -->
            <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="featured-slider owl-carousel owl-theme">
                        ...
                        $query_1  = "SELECT * FROM `ADVERTISEMENT` WHERE `CATEGORY_id` = '75'";
                        $result_1 = mysqli_query($mysqli, $query_1);
                        while ($row = mysqli_fetch_assoc($result_1)){
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="heading-panel">
                <div class="col-xs-12 col-md-12 col-sm-12">
                    <h3 class="main-title text-left">
                        Latest Ads in <a href="ad_per_cat.php?cat_id=68&dis=all&price=all&order=latest" style="color:  rgba(166,85,218,0.86) ">Home & Garden</a>
                    </h3>
                </div>
            </div>
            <!-- Middle Content Box -->
            <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="featured-slider owl-carousel owl-theme">
                        ...
                        $query_1  = "SELECT * FROM `ADVERTISEMENT` WHERE `CATEGORY_id` = '68'";
                        $result_1 = mysqli_query($mysqli, $query_1);
                        while ($row = mysqli_fetch_assoc($result_1)){
