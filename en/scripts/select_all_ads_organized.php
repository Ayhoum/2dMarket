...
//include '../../scripts/db_connection.php';
    ...
    if (isset($_GET['price'])) {
        if ($_GET['price'] == "higtolow") {
            $ad_query = "SELECT * FROM `ADVERTISEMENT` WHERE `lang` = 'EN'  && `selling_type` <> 'BID' ORDER BY `price` ASC ";
                            ...
                            <div class="category-grid-img">
                                ...
                                <div class="user-preview">
                                    <a href="profile_2.php?user_id=<?php echo $user_id; ?>"> <img
                                                ...
                                                class="avatar avatar-small" alt="<?php echo $user_username; ?>"> </a>
                                </div>
                                <!-- View Details --><a href="ad_page.php?ad_id=<?php echo $ad_id; ?>"
                                                        class="view-details">View
                                    Details</a>
                                <!-- Additional Info -->
