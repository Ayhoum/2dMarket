...
$ad_query_get_num = "SELECT ADVERTISEMENT.*, ADDRESS.USER_id
                                          ...
                                          WHERE ADDRESS.country LIKE '%{$country}%' ORDER BY ADVERTISEMENT.id DESC";
...
if($num_Ads <= 10){
    ...
    $ad_query = "SELECT ADVERTISEMENT.*, ADDRESS.USER_id
                                          FROM ADVERTISEMENT
                                          LEFT JOIN ADDRESS ON ADVERTISEMENT.USER_id = ADDRESS.USER_id
                                          WHERE ADDRESS.country LIKE '%{$country}%' ORDER BY ADVERTISEMENT.id DESC LIMIT 10 OFFSET $start";
