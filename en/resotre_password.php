				...
				<tr>
					<td align='center' valign='top'>
						...
						<table class='container hero-subheader' border='0' cellpadding='0' cellspacing='0' width='620' style='width: 620px;'>
							...
							<tr>
								<td class='hero-subheader__content' style='direction:ltr;font-size: 16px; line-height: 27px; color: #969696; padding: 0 60px 90px 0;' align='left'>To reset your password:<br>
                ...
                <div class="col-sm-offset-0 col-sm-12 col-md-offset-3 col-md-6">
                    ...
                    <div class="form-grid">
                        <form action="resotre_password.php" name="login" id="login_form" method="post" data-toggle="validator">
                            ...
                            <button type="submit" class="btn btn-theme btn-lg btn-block" name="forgot_submit">Restore</button>
