        ...
        <div class="dashboard-content">
            ...
            <div class="headline inbox buttons two primary">
				...
				<div class="button-wrap">
					<a href="#" class="button square dark-light">
                    ...
                    <div class="inbox-message-preview-body">
						...
						<div class="comment-list">
							...
							<div class="comment-wrap">
								...
								<a href="user-profile.html">
									<figure class="user-avatar medium">
										<img src="images/avatars/avatar_01.jpg" alt="">
									</figure>
								</a>
								<!-- /USER AVATAR -->
								<div class="comment">
							...
							<div class="comment-wrap comment-reply">
								...
								<div class="style-tool-bar">
									<p class="text-header">Styling Tool Bar:</p>

									<!-- STYLE TOOL BAR OPTIONS -->
									<ul class="style-tool-bar-options">
										<li><p>H1</p></li>
										<li><p>H2</p></li>
										<li><p>H3</p></li>
										<li><p>P</p></li>
