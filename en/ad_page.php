...
//    $id = $_GET['ad_id'];
    $id = 1;
//ad_info
$ad_query  = "SELECT * FROM `ADVERTISEMENT` WHERE `id` = '{$id}'";
...
<html lang="en">
   <head>
      ...
      <title>2D Market | <?php $title ?></title>
      <!-- =-=-=-=-=-=-= Favicons Icon =-=-=-=-=-=-= -->
                     ...
                     <div class="single-ad">
                        ...
                        <div class="ad-box">
                           ...
                           <div class="short-history">
                              <ul>
                                 ...
                                 <li>Category: <b><a href="category.php?category_id=<?php echo $category_id; ?>"><?php echo $cat_name ; ?></a></b></li>
                        ...
                        <div class="ad-box">
                           <div class="short-features">
                              ...
                              <div class="col-sm-4 col-md-4 col-xs-12 no-padding">
                                 <span><strong>Price</strong> :</span> <?php //$price; ?>
                              </div>
                           </div>
                           <!-- Short Features  --> 
