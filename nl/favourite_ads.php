...
<head>
    ...
    <title> 2D Market |Favoriete Advertenties</title>
    <!-- =-=-=-=-=-=-= Favicons Icon =-=-=-=-=-=-= -->
                ...
                <div class="col-md-4 col-sm-12 col-xs-12 leftbar-stick blog-sidebar">
                    ...
                    <div class="user-profile">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="favourite_ads.php">Favorieten advertenties <span class="badge"><?php echo $fav_count; ?></span></a></li>
