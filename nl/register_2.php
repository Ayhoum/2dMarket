				...
				<tr>
					<td align=\"center\" valign=\"top\">
						...
						<table class=\"container hero-subheader\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"620\" style=\"width: 620px;\">
							...
							<tr>
								<td class=\"hero-subheader__content\" style=\"direction:ltr;font-size: 16px; line-height: 27px; color: #969696; padding: 0 60px 90px 0;\" align=\"right\">Bevestigen :<br>
...
<html lang="en">
   <head>
      ...
      <title>2D Market | Inschrijven</title>
      <!-- =-=-=-=-=-=-= Favicons Icon =-=-=-=-=-=-= -->
                     ...
                     <div class="post-ad-form extra-padding postdetails">
                        ...
                        <form  name="add_new_ad" method="post" action="register_2.php?id=<?php echo $_GET['id'];?>" class="submit-form" enctype="multipart/form-data">
                         <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
                             <div class="row">
                                 <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
                                     <label class="control-label">Straatnaam <small></small></label>
                             ...
                             <div class="row">
                                 <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
                                     <label class="control-label">Land <small></small></label>
                             ...
                             <div class="row">
                                 <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
                                     <label class="control-label">Provence <small></small></label>
                             ...
                             <div class="row">
                                 <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
                                     <label class="control-label">Stad <small></small></label>
