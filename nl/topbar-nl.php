    ...
    <div class="container">
        <div class="row">
            ...
            <div class="header-top-left col-md-8 col-sm-6 col-xs-12 hidden-xs">
                <ul class="listnone">
                    <li><a href="about.php"><i class="fa fa-heart-o" aria-hidden="true"></i> Over ons</a></li>
                    <li><a href="faqs.php"><i class="fa fa-folder-open-o" aria-hidden="true"></i> FAQS</a></li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-globe" aria-hidden="true"></i> Taal <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo $en;?>">Engels</a></li>
                            <li><a href="<?php echo $nl;?>">Nederlands</a></li>
                            <li><a href="<?php echo $ar;?>">Arabisch</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
                ...
                <div class="pull-right">
                    <ul class="listnone">
                        ...
                        <?php if(!isset($_SESSION['username'])){?>
                            <li><a href="login.php"><i class="fa fa-sign-in"></i> Inloggen</a></li>
                            <li><a href="register.php"><i class="fa fa-unlock" aria-hidden="true"></i> Aanmelden</a></li>
                        <?php } else{ ?>
                            <li class="dropdown">
