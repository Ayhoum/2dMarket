            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 col-xs-12 leftbar-stick blog-sidebar">
                    ...
                    <div class="user-profile">
                        ...
                        <ul>
                            <li class="active"><a href="profile.php">Mijn Profile</a></li>
                    ...
                    <div class="profile-section margin-bottom-20">
                        <div class="profile-tabs">
                            <ul class="nav nav-justified nav-tabs">
                                ...
                                <li><a href="#edit" data-toggle="tab">Profile Bewerken</a></li>
                            ...
                            <div class="tab-content">
                                <div class="profile-edit tab-pane fade in active" id="profile">
                                    ...
                                    <dl class="dl-horizontal">
                                        ...
                                        <dt><strong>Telefonenummer </strong></dt>
                                        <dd>
                                            <?php echo $user_phone ;?>
                                        </dd>
                                        <dt><strong>Uw Gebruikersnaam </strong></dt>
                                        <dd>
                                ...
                                <div class="profile-edit tab-pane fade" id="edit">
                                    <h2 class="heading-md">Profile Bewerken</h2>
                                    ...
                                    <form method="post" action="scripts/edit_profile_info.php" enctype="multipart/form-data">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12" >
                                                <button style="width: 100%" type="submit" class="btn btn-theme btn-sm" name="update">Updaten</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
