                                                ...
                                                <div class="content-area">
                                                    <div class="col-md-9 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="ad-details">
                                                            <p>Uw Bod  : <?php if ($am_amount <= $amount) { ?> <span style="color: green"><?php echo $amount . "   Uw hebt de hoogeste bod  ";?> </span><?php } else {?><span style="color: red"><?php echo $amount;?> </span><?php }?></p>
                                                            <p>Hoogeste Bod : <span><?php echo $am_amount;?></span></p>
                                                            <p>Laatste Biedingsdatum : <span><?php echo $am_date ; ?></span> </p>
                                                        </div>
                                                    </div>
