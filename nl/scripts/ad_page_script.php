...
//should we delete the previous bids from the same user??. Also, don't forget to send email !
            ...
            $mail->CharSet = 'UTF-8';
            $mail->IsHTML(true);
            $link = "http://www.2dmarket.com/nl/ad_page.php?".$ad_id;
            $body             = "
...
<head>
	...
	<title>2D Market | Nieuw bod </title>
	<style type=\"text/css\">
		/* ----- Custom Font Import ----- */
				...
				<tr>
					<td align='center' valign='top'>
						...
						<table class='container hero-subheader' border='0' cellpadding='0' cellspacing='0' width='620' style='width: 620px;'>
							<tr>
								<td class='hero-subheader__title' style='direction:ltr;font-size: 43px; font-weight: bold; padding: 80px 0 15px 0;' align='center'>Iemand heeft een bod uitgebracht op uw advertentie. </td>
							</tr>

							<tr>
								<td class='hero-subheader__content' style='direction:ltr;font-size: 16px; line-height: 27px; color: #969696; padding: 0 60px 90px 0;' align='left'>U heeft een nieuw bod geregistreerd op uw advertentie.  <br>
								om het te bekijken : <a href='$link'>Klik hier !</a>
								</td>
							</tr>
						</table>
...
";
        ...
        <div role="alert" class="alert alert-warning alert-dismissible">
            <button aria-label="Close" data-dismiss="alert" class="close" type="button"></button>
            om een bod op dit product te kunnen doen <strong><a href="login.php">Log alstublieft in! </a></strong>
        </div>
        <?php
    }
}
