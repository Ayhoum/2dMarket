...
<head>
    ...
    <title>2D Market | إستعادة كلمة المرور</title>
    <!-- =-=-=-=-=-=-= Favicons Icon =-=-=-=-=-=-= -->
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="header-page text-center">
                    <h1>إستعادة كلمة المرور الخاصة بك</h1>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="form-grid">
                        <form action="index.php" name="login" id="login_form" method="post" data-toggle="validator">
                            <div class="form-group">
                                <label>إن كنت مسجل لديتا في الموقع، سوف يتم إرسال بريد إلكتروني إليك</label>
                            </div>

                            <button type="submit" class="btn btn-theme btn-lg btn-block" name="okay">حسناً</button>
