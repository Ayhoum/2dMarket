...
<head>
    ...
    <title>2D Market | صفحـة: <?php echo $user_username;?></title>
    <!-- =-=-=-=-=-=-= Favicons Icon =-=-=-=-=-=-= -->
                                    ...
                                    <div class="row ad-history">
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="user-stats">
                                                ...
                                                <small>إعلان مبــاع</small>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="user-stats">
                                                <h2><?php echo $ad_count;?></h2>
                                                <small>مجموع الاعلانـات</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!--                        <ul>-->
<!--                            <li class="active">-->
<!--                                    <div class="menu-name"> الاعلانات المنشورة من قبل --><?php //echo $user_username;?><!-- </div>-->
<!--                                </a>-->
<!--                            </li>-->
<!--                        </ul>-->
<!--                    </div>-->
