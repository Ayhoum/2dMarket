...
//if its nothing encrypt the pass and go ON
        ...
        $results = mysqli_query($mysqli, $query);
            ...
            phpAlert(   "كلمه المرور / اسم المستخدم غير صحيح"  );
...
<!-- SECTION HEADLINE -->
<div class="section-headline-wrap"  style="direction: rtl">
    <div class="section-headline">
       <div id="welkom_ar" style="margin-left:25%; "> <h2>أهلا بك ..</h2></div>
...
<div class="section-wrap">
    <div class="section demo">
        ...
        <div class="form-popup">
            ...
            <!-- FORM POPUP CONTENT -->
            <div class="form-popup-content" style="direction: rtl">
                <h4 class="popup-title">تسجيل الدخول:</h4>
                <!-- LINE SEPARATOR -->
                <hr class="line-separator">
                <!-- /LINE SEPARATOR -->
                <form id="login-form" action="#" method="post">
                    <label for="email" class="rl-label">البريد الالكتروني</label>
                    <input type="text" id="username" name="email" placeholder="الرجاء إدخال البريد الالكتروني...">
                    <label for="password" class="rl-label">كلمه المرور</label>
                    <input type="password" id="password" name="password" placeholder="الرجاء إدخال كلمه المرور... ">
                    <!-- CHECKBOX -->
                    ...
                    <!-- /CHECKBOX -->
                    <p>هل نسيت كلمه المرور الخاصخ بك؟ <a href="#" class="primary"> إضغط إذا هنا</a></p>
                    <button class="button mid dark" name="Log_in">سجل <span class="primary">الدخول</span></button>
                </form>
                <!-- LINE SEPARATOR -->
                <hr class="line-separator double">
                <!-- /LINE SEPARATOR -->
                <a href="#" class="button mid fb half">قم بالتسجل عن طريق فيس بوك</a>
                <a href="#" class="button mid twt half">قم بالتسجل عن طريق تويتر</a>
            </div>
            <!-- /FORM POPUP CONTENT -->
        </div>
        <!-- /FORM POPUP -->
