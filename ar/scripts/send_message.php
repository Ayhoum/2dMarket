...
if (isset($_POST['submit'])){
    ...
    $chat_result = mysqli_query($mysqli, $chat_query);
        ...
        $link = "http://www.2dmarket.com/ar/login.php";
				...
				<tr>
					<td align='center' valign='top'>
						...
						<table class='container hero-subheader' border='0' cellpadding='0' cellspacing='0' width='620' style='width: 620px;'>
							<tr>
								<td class='hero-subheader__title' style='direction:ltr;font-size: 43px; font-weight: bold; padding: 80px 0 15px 0;' align='center'>لقد وصلتك رسـالة جديدة</td>
							</tr>

							<tr>
								<td class='hero-subheader__content' style='direction:ltr;font-size: 16px; line-height: 27px; color: #969696; padding: 0 60px 90px 0;' align='right'>لقراءة الرسـالة:<br>
...
";
    ...
    $mail->Subject    = "رسالة جديدة على 2DMarket";
