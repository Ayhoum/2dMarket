...
$ad_query_get_num = "SELECT * FROM `ADVERTISEMENT` WHERE `USER_id` = '{$user_id}' AND `lang` ='AR'";
...
<div class="posts-masonry">
    ...
    <?php
    if($num_Ads <= 6){
        $ad_query = "SELECT * FROM `ADVERTISEMENT` WHERE `USER_id` = '{$user_id}' AND `lang` ='AR' ORDER BY `date` DESC";
    }else if($page == 0 || $page == 1){
        $ad_query = "SELECT * FROM `ADVERTISEMENT` WHERE `USER_id` = '{$user_id}' AND `lang` ='AR' ORDER BY `date` DESC LIMIT 6";
    }else if($page > 1){
        $start = (($page - 1) * 6);
        $ad_query = "SELECT * FROM `ADVERTISEMENT` WHERE `USER_id` = '{$user_id}' AND `lang` ='AR' ORDER BY `date` DESC LIMIT 6 OFFSET $start";
...
// Address info.
            ...
            <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12 ">
                <div class="white category-grid-box-1 ">
                    ...
                    <div class="image"><img src="ar_ad_photo/<?php echo $picture_name; ?>" class="img-responsive">
                    ...
                    <div class="ad-info-1">
                        ...
                        <ul class="pull-right">
                            <li><a data-toggle="tooltip" data-placement="top" title=""
                                   data-original-title="عدل الاعلان"
                                   href="edit_ad.php?ad_id=<?php echo $ad_id; ?>"><i class="fa fa-pencil edit"></i></a>
                            </li>
<!--                            <li><a data-toggle="tooltip" data-placement="top" title="" data-original-title="احذف الاعلان"-->
        ...
        <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
            <section class="advertising">
                <a href="new_advertisement.php">
                    <div class="banner">
                        <div class="wrapper">
                            <span class="title">يبدو انك لم تقم بنشر اي اعلان</span>
                            <span class="submit">قم بنشر اعلان الان! <i class="fa fa-plus-square"></i></span>
                        </div>
                    </div>
                    <!-- /.banner-->
                </a>
