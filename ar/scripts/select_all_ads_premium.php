...
if (isset($_GET['cat_id'])){
    $cat_id    = $_GET['cat_id'];
    $ad_query  = "SELECT * FROM `ADVERTISEMENT` WHERE `lang` = 'AR' && `CATEGORY_id` = '{$cat_id}'  && `ad_type` = 'PREMIUM' ORDER BY `date` DESC";
...
// Address info.
            ...
            <div class="col-md-6 col-xs-12 col-sm-6">
                ...
                <div class="category-grid-box">
                    ...
                    <div class="short-description">
                        <!-- Ad Category -->
                        <?php      if ($status == "SOLD"){?>        <p> <span class="label label-danger"><?php echo "مبــاع" ;?></span></p>
                        <?php }elseif ($status == "RESERVED"){?>    <p> <span class="label label-warning"><?php echo "محجــوز"  ;?></span></p>
                        <?php }elseif ($status == "AVAILABLE"){?>  <p> <span class="label label-success"><?php echo "متــاح" ;?></span></p><?php }?>
    ...
    $ad_query  = "SELECT * FROM `ADVERTISEMENT` WHERE `lang` = 'AR' && `ad_type` = 'PREMIUM' ORDER BY `date` DESC";
    $ad_result = mysqli_query($mysqli, $ad_query);
