                                    ...
                                    <div class="well ad-listing clearfix">
                                        <div class="col-md-3 col-sm-5 col-xs-12 grid-style no-padding">
                                            ...
                                            <div class="img-box">
                                                ...
                                                <div class="total-images"><strong><?php echo $image_num;?></strong> صورة </div>
                                            </div>
                                            <!-- Ad Status --><?php if ($ad_type == "PREMIUM") {?><span class="ad-status"> متميـز </span> <?php } ?>
                                            <!-- User Preview -->
                                            <div class="user-preview">
<!--                                                <a href="#"> <img src="../uploads/users/--><?php //echo $usr_pic?><!--" class="avatar avatar-small" alt=""> </a>-->
                                            </div>
                                        </div>
                                                ...
                                                <div class="content-area">
                                                    <div class="col-md-9 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="ad-details">
                                                            <p>المزايدة الخاصة بك  : <?php if ($am_amount <= $amount) { ?> <span style="color: green"><?php echo $amount . "   أنت صاحب اعلى مزايدة ";?> </span><?php } else {?><span style="color: red"><?php echo $amount;?> </span><?php }?></p>
                                                            <p>أعلى مزايدة : <span><?php echo $am_amount;?></span></p>
                                                            <p>تـاريخ اخر مزايدة : <span><?php echo $am_date ; ?></span> </p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-xs-12 col-sm-12">
                                                        ...
                                                        <!-- Ad View Button -->
                                                        <button class="btn btn-block btn-success" onclick="window.location.href='ad_page.php?ad_id=<?php echo $ad_id; ?>'"><i class="fa fa-eye" aria-hidden="true" ></i> مشـاهدة الاعلان </button>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Ad Content End -->
