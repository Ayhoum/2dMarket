...
$ads = "SELECT * FROM `ADVERTISEMENT` WHERE `lang` = 'AR' ORDER BY `id` DESC LIMIT 6";
            ...
            <div class="col-md-12 col-xs-12 col-sm-12 clearfix">
                ...
                <div class="category-grid-box">
                    ...
                    <div class="category-grid-img">
                        ...
                        <!-- Ad Status --><?php if ($ad_type == "PREMIUM") {  ?><span class="ad-status"> بريميوم </span><?php } ?>
                        <!-- User Review -->
                        <div class="user-preview">
                            <a href="profile_2.php?user_id=<?php  echo $user_id;?>"> <img src="<?php echo $user_pic;?>" class="avatar avatar-small" alt=""> </a>
                        </div>
                        <!-- View Details --><a href="ad_page.php?ad_id=<?php echo $ad_id?>" class="view-details">مشاهدة المزيد من التفاصيل </a>
                        <!-- Additional Info -->
                    ...
                    <div class="short-description">
                        ...
                        <!-- Price -->
                        <div class="price"><?php if ($selling_type == "FIXED_PRICE"){  echo "€ ". $price; }else { echo "(مزاد)";}?></div>
                    </div>
                    <!-- Addition Info -->
                    <div class="ad-info">
                        <ul>
