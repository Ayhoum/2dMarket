    ...
    <div class="single-ad">
        ...
        <div class="ad-box">
            ...
            <div class="short-history">
                <ul>
                    <li>نُشر بتاريخ: <b><?php echo $date; ?></b></li>
                    <li>نُشر بواسطة: <b><a href="profile_2.php?user_id=<?php echo $user_id;?>"><?php echo $user_username; ?></a></b></li>
                    <!--                    <li>Category: <b><a href="ads_per_cat.php?cat_id=--><?php //echo $category_id;?><!--">--><?php //echo $cat_name; ?><!--</a></b></li>-->
                    <li>الموقع: <b><?php echo $user_region . " | " . $user_country; ?></b></li>
                </ul>
            </div>
        </div>
        ...
        <div class="ad-box">
            <div class="short-features">
                ...
                <div class="col-sm-4 col-md-4 col-xs-12 no-padding">
                    <span><strong>حالة المنتج</strong> :</span> <?php echo $condition; ?>
                </div>
                <div class="col-sm-4 col-md-4 col-xs-12 no-padding">
                    <span><strong>التوفر</strong> :</span> <?php echo $status; ?>
                </div>
                <div class="col-sm-4 col-md-4 col-xs-12 no-padding">
                    <span><strong>طريقة التوصيل</strong> :</span> <?php echo $delivery_type; ?>
                </div>
                <div class="col-sm-4 col-md-4 col-xs-12 no-padding">
                    <span><strong>الفئة</strong>:</span> <?php echo $cat_name; ?>
                </div>
                <div class="col-sm-4 col-md-4 col-xs-12 no-padding">
                    <span><strong>منذ</strong> :</span> <?php echo $date; ?>
                </div>
                <div class="col-sm-4 col-md-4 col-xs-12 no-padding">
                    <span><strong>السعر</strong> :</span> € <?php echo $price; ?>
                </div>
                <div class="col-sm-4 col-md-4 col-xs-12 no-padding">
                    <span><strong>طريقة البيع</strong> :</span> <?php echo $selling_type; ?>
                </div>
            </div>
            <!-- Short Features  -->
...
//should we delete the previous bids from the same user??. Also, don't forget to send email !
            ...
            $mail->CharSet = 'UTF-8';
            $mail->IsHTML(true);
            $link = "http://www.2dmarket.com/ar/ad_page.php?".$ad_id;
...
<head>
	...
	<title>2D Market | مزايدة جديدة</title>
	<style type='text/css'>
		/* ----- Custom Font Import ----- */
				...
				<tr>
					<td align='center' valign='top'>
							...
							<tr>
								<td class='info-bullets__block' style='padding: 30px 30px 15px 30px;' align='center'>
									<table class='container' border='0' cellpadding='0' cellspacing='0' align='center'>
										<tr>
											<td align='center' width='60' height='2' style=' width: 60px; height: 2px; font-size: 1px;'><img src='http://www.2dmarket.com/ar/images/logo_files/logo_png_email.png'></td>
										</tr>
									</table>
								</td>
						...
						<table class='container hero-subheader' border='0' cellpadding='0' cellspacing='0' width='620' style='width: 620px;'>
							<tr>
								<td class='hero-subheader__title' style='direction:ltr;font-size: 43px; font-weight: bold; padding: 80px 0 15px 0;' align='center'>لديك مزايدة جديدة على منتجك : </td>
							</tr>

							<tr>
								<td class='hero-subheader__content' style='direction:ltr;font-size: 16px; line-height: 27px; color: #969696; padding: 0 60px 90px 0;' align='right'>لمشاهدة المزايدة :<br>
...
";
            ...
            <table class="table">
                ...
                if (mysqli_num_rows($get_auction_result) > 0) {
                    ...
                    <div role="alert" class="alert alert-warning alert-dismissible">
                        ...
                        <strong>لا يوجد أي مزايدات حالياً</strong> قم بتقديم مزايدة لتكون الأول.
                    </div>
                    <?php
                }
                ?>
        ...
        <?php if (isset($_SESSION['username'])) { ?>
            <div class="well">
                <h3>قم بالمزايدة الآن</h3>
                <form action=" " method="post">
                    <div class="row">
                        <div class="col-md-5 col-xs-12 col-sm-12">
                            <input name="bid" placeholder="أدخل قيمة المزايدة" type="text" class="form-control">
                        </div>
                        <div class="col-md-3 col-xs-12 col-sm-12">
                            <input name="submit" class="btn btn-theme btn-block" value="نشر" type="submit">
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div role="alert" class="alert alert-warning alert-dismissible">
                        <button aria-label="Close" data-dismiss="alert" class="close" type="button"></button>
                        لتتمكن من المزايدة الرجاء قم <strong><a href="login.php"> بتسجيل الدخول</a></strong>
                    </div>
            <?php
        }
    }
    ...
    <div class="grid-panel margin-top-30">
        ...
        <div class="posts-masonry">
            <div class="col-md-12 col-xs-12 col-sm-12">
                <!-- Ads Archive -->
                <?php
                $related_ad_query = "SELECT * FROM `ADVERTISEMENT` WHERE CATEGORY_id = '{$category_id}' AND lang = 'AR' ORDER BY `id` DESC LIMIT 4";
...
// Address info.
                    ...
                    echo "لا يوجد إعلانات لإظهارها هنا!";
                }
                ?>
