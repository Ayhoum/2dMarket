            ...
            <div class="heading-panel">
                <div class="col-xs-12 col-md-12 col-sm-12">
                    <h3 class="main-title text-left">
                        احدث الاعلانـات في <a href="ad_per_cat.php?cat_id=60&dis=all&price=all&order=latest" style="color: rgba(166,85,218,0.86) ">الاجهزة الالكترونيـة</a>
                    </h3>
                </div>
            </div>
            <!-- Middle Content Box -->
            <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="featured-slider owl-carousel owl-theme">
                        ...
                        $query_1  = "SELECT * FROM `ADVERTISEMENT` WHERE `CATEGORY_id` = '60'";
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="heading-panel">
                <div class="col-xs-12 col-md-12 col-sm-12">
                    <h3 class="main-title text-left">
                        احدث الاعلانـات في <a href="ad_per_cat.php?cat_id=67&dis=all&price=all&order=latest" style="color:  rgba(166,85,218,0.86) ">الاجهزة المنزليـة</a>
                    </h3>
                </div>
            </div>
            <!-- Middle Content Box -->
            <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="featured-slider owl-carousel owl-theme">
                        ...
                        $query_1  = "SELECT * FROM `ADVERTISEMENT` WHERE `CATEGORY_id` = '67'";
                        $result_1 = mysqli_query($mysqli, $query_1);
                        while ($row = mysqli_fetch_assoc($result_1)){
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="heading-panel">
                <div class="col-xs-12 col-md-12 col-sm-12">
                    <h3 class="main-title text-left">
                        احدث الاعلانـات في <a href="ad_per_cat.php?cat_id=70&dis=all&price=all&order=latest" style="color:  rgba(166,85,218,0.86) "> المنازل والحدائق </a>
                    </h3>
                </div>
            </div>
            <!-- Middle Content Box -->
            <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="featured-slider owl-carousel owl-theme">
                        ...
                        $query_1  = "SELECT * FROM `ADVERTISEMENT` WHERE `CATEGORY_id` = '70'";
                        $result_1 = mysqli_query($mysqli, $query_1);
                        while ($row = mysqli_fetch_assoc($result_1)){
