            ...
            if($us_id != $idUser){
                ...
                if(!empty($lon) && !empty($lat)){
                    ...
                    if($km <= $dis) {
                        if($_GET['price'] != 'all'){
                            if($minPrice == 0){
                                $queryAD = "SELECT * FROM ADVERTISEMENT WHERE `CATEGORY_id` = '{$cat}' AND (`sub_cat_id` IS NULL OR `sub_cat_id` = '{$subCat}') AND (`title` LIKE '%$searchTxt%' OR `description` LIKE '%$searchTxt%') AND `USER_id` = '{$us_id}' AND `lang` = 'AR' AND `price` <= '$maxPrice'";
                            }else if($maxPrice == 'max'){
                                $queryAD = "SELECT * FROM ADVERTISEMENT WHERE `CATEGORY_id` = '{$cat}' AND (`sub_cat_id` IS NULL OR `sub_cat_id` = '{$subCat}') AND (`title` LIKE '%$searchTxt%' OR `description` LIKE '%$searchTxt%') AND `USER_id` = '{$us_id}' AND `lang` = 'AR' AND `price` >= '$minPrice'";
                            }else{
                                $queryAD = "SELECT * FROM ADVERTISEMENT WHERE `CATEGORY_id` = '{$cat}' AND (`sub_cat_id` IS NULL OR `sub_cat_id` = '{$subCat}') AND (`title` LIKE '%$searchTxt%' OR `description` LIKE '%$searchTxt%') AND `USER_id` = '{$us_id}' AND `lang` = 'AR' AND (`price` >= '$minPrice' AND `price` <= '$maxPrice')";
                            }
                        }else{
                            $queryAD = "SELECT * FROM ADVERTISEMENT WHERE `CATEGORY_id` = '{$cat}' AND (`sub_cat_id` IS NULL OR `sub_cat_id` = '{$subCat}') AND (`title` LIKE '%$searchTxt%' OR `description` LIKE '%$searchTxt%') AND `USER_id` = '{$us_id}' AND `lang` = 'AR' ";
                        }
...
//         WHERE `id` IN (' . implode(',', array_map('intval', $array)) . ')';
        ...
        if ($num_Ads <= 10) {
            $ad_query = "SELECT * FROM `ADVERTISEMENT` WHERE `id` IN ('$ids') AND `lang` = 'AR'  ORDER BY `ad_type` DESC," . $suffix;
        } else if ($page == 0 || $page == 1) {
            $ad_query = "SELECT * FROM `ADVERTISEMENT` WHERE `id` IN ('$ids') AND `lang` = 'AR'  ORDER BY `ad_type` DESC," . $suffix ." LIMIT 10";
        } else if ($page > 1) {
            $start = (($page - 1) * 10);
            $ad_query = "SELECT * FROM `ADVERTISEMENT` WHERE `id` IN ('$ids') AND `lang` = 'AR'  ORDER BY `ad_type` DESC," . $suffix ." LIMIT 10 OFFSET $start";
        }
        ...
        while ($row = mysqli_fetch_assoc($run_query)){
            ...
            if(!empty($lon) && !empty($lat)){
                ...
                if($km <= $dis) {
                    if($_GET['price'] != 'all'){
                        if($minPrice == 0){
                            $queryAD = "SELECT * FROM ADVERTISEMENT WHERE `CATEGORY_id` = '{$cat}' AND (`sub_cat_id` IS NULL OR `sub_cat_id` = '{$subCat}') AND (`title` LIKE '%$searchTxt%' OR `description` LIKE '%$searchTxt%') AND `lang` = 'AR' AND `price` <= '$maxPrice'";
                        }else if($maxPrice == 'max'){
                            $queryAD = "SELECT * FROM ADVERTISEMENT WHERE `CATEGORY_id` = '{$cat}' AND (`sub_cat_id` IS NULL OR `sub_cat_id` = '{$subCat}') AND (`title` LIKE '%$searchTxt%' OR `description` LIKE '%$searchTxt%') AND `lang` = 'AR' AND `price` >= '$minPrice'";
                        }else{
                            $queryAD = "SELECT * FROM ADVERTISEMENT WHERE `CATEGORY_id` = '{$cat}' AND (`sub_cat_id` IS NULL OR `sub_cat_id` = '{$subCat}') AND (`title` LIKE '%$searchTxt%' OR `description` LIKE '%$searchTxt%') AND `lang` = 'AR' AND (`price` >= '$minPrice' AND `price` <= '$maxPrice')";
                        }
                    }else{
                        $queryAD = "SELECT * FROM ADVERTISEMENT WHERE `CATEGORY_id` = '{$cat}' AND (`sub_cat_id` IS NULL OR `sub_cat_id` = '{$subCat}') AND (`title` LIKE '%$searchTxt%' OR `description` LIKE '%$searchTxt%') AND `lang` = 'AR' ";
                    }
