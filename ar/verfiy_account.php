...
<head>
	...
	<title>2D Market | اهـلاً وسهلاً</title>
	<style type='text/css'>
		/* ----- Custom Font Import ----- */
				...
				<tr>
					<td align='center' valign='top'>
						...
						<table class='container hero-subheader' border='0' cellpadding='0' cellspacing='0' width='620' style='width: 620px;'>
							<tr>
								<td class='hero-subheader__title' style='direction:ltr;font-size: 43px; font-weight: bold; padding: 80px 0 15px 0;' align='center'>لقد اكتسبت عائلتنا فرداَ جديداً</td>
							</tr>

							<tr>
								<td class='hero-subheader__content' style='direction:ltr;font-size: 16px; line-height: 27px; color: #969696; padding: 0 60px 90px 0;' align='right'>اهلأ وسهلاً بك في موقعنا ك مستخدم جديد<br>
								<a href='$link'>إضغط هنا للبدء!</a>
								</td>
							</tr>
						</table>
