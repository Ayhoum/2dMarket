...
<!DOCTYPE html>
AR    <meta http-equiv="content-type" content="text/html;charset=UTF-8" />
    <!--[if IE]>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <![endif]-->
    <meta name="description" content="">
    <meta name="author" content="ScriptsBundle">
    <title>2D Market | الصفحـة الشخصـية</title>
    <!-- =-=-=-=-=-=-= Favicons Icon =-=-=-=-=-=-= -->
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 col-xs-12 leftbar-stick blog-sidebar">
                    ...
                    <div class="user-profile">
                        ...
                        <ul>
                            <li class="active"><a href="profile.php">الصفـحة الشخـصية</a></li>
                            <li  ><a href="personal_ads.php">اعلانـاتي <span class="badge"><?php echo $ad_count; ?> </span></a></li>
                    ...
                    <div class="profile-section margin-bottom-20">
                        <div class="profile-tabs">
                            <ul class="nav nav-justified nav-tabs">
                                ...
                                <li><a href="#edit" data-toggle="tab">تعديل المعلومات الشخصية</a></li>
                            </ul>
                            <div class="tab-content">
                                <div class="profile-edit tab-pane fade in active" id="profile">
                                    <h2 class="heading-md">المعومات الشخصية الخاصة بك</h2>
                                    <dl class="dl-horizontal">
                                        <dt><strong>الاسـم الكـامل </strong></dt>
                                        <dd>
                                            <?php echo  $user_full_name ;?>
                                        </dd>
                                        <dt><strong>البريـد الالكترونـي </strong></dt>
                                        <dd>
                                            <?php echo  $user_email ;?>
                                        </dd>
                                        ...
                                        <dt><strong>اسم المستخـدم </strong></dt>
                                        <dd>
                                            <?php echo $user_username ;?>
                                        </dd>
                                        <dt><strong>العنوان </strong></dt>
                                        <dd>
                                ...
                                <div class="profile-edit tab-pane fade" id="edit">
                                    <h2 class="heading-md">تعديل معلوماتك الشخصيـة</h2>
                                    <p>قم بتعئبة الفورم لتعديل بياناتك</p>
                                    <div class="clearfix"></div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row ">
                                                <div class="col-md-12 col-sm-12 col-xs-12" >
                                                    <button style="width: 100%" type="submit" class="btn btn-theme btn-sm" name="update">تعديـل المعلومات</button>
                                                </div>
                                            </div>
                                    </form>
                                </div>
